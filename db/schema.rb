...
ActiveRecord::Schema[7.1].define(version: 2024_06_07_094856) do
  ...
  create_table "account_moderation_notes", id: :bigint, default: -> { "timestamp_id('account_moderation_notes'::text)" }, force: :cascade do |t|
  ...
  create_table "account_pins", id: :bigint, default: -> { "timestamp_id('account_pins'::text)" }, force: :cascade do |t|
    t.bigint "account_id"
    t.bigint "target_account_id"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "account_relationship_severance_events", id: :bigint, default: -> { "timestamp_id('account_relationship_severance_events'::text)" }, force: :cascade do |t|
    t.bigint "account_id", null: false
  ...
  create_table "admin_action_logs", id: :bigint, default: -> { "timestamp_id('admin_action_logs'::text)" }, force: :cascade do |t|
    t.bigint "account_id"
  ...
  create_table "invites", id: :bigint, default: -> { "timestamp_id('invites'::text)" }, force: :cascade do |t|
  ...
  create_table "list_accounts", id: :bigint, default: -> { "timestamp_id('list_accounts'::text)" }, force: :cascade do |t|
  ...
  create_table "notification_permissions", id: :bigint, default: -> { "timestamp_id('notification_permissions'::text)" }, force: :cascade do |t|
    t.bigint "account_id", null: false
  ...
  create_table "notification_policies", id: :bigint, default: -> { "timestamp_id('notification_policies'::text)" }, force: :cascade do |t|
    t.bigint "account_id", null: false
  ...
  create_table "relationship_severance_events", id: :bigint, default: -> { "timestamp_id('relationship_severance_events'::text)" }, force: :cascade do |t|
    t.integer "type", null: false
  ...
  create_table "severed_relationships", id: :bigint, default: -> { "timestamp_id('severed_relationships'::text)" }, force: :cascade do |t|
    t.bigint "relationship_severance_event_id", null: false
